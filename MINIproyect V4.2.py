...
# Parámetros para la estimación de distancia (ajusta según tu objeto y pruebas)
REAL_WIDTH_CM = 5.0            # Ancho real del objeto (cm)
KNOWN_DISTANCE_CM = 20.0       # Distancia de calibración (cm)
KNOWN_WIDTH_PIXELS = 100       # Ancho en píxeles del objeto a la distancia conocida
